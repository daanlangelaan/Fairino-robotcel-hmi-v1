...
-- Variant: fk_full_demo_hmi
-- Generated: 20260526_162022
...
function clamp_place_valve_and_verify()
    clamp_place_valve()
...
function state_clamp_filter()
    ...
    if clamp_place_and_verify() then
        current_state = S90_PICK_VALVE
    end
end

function state_pick_valve()
    set_running_lamps()
    pick_valve_motion()
    current_state = S95_PLACE_VALVE
end

function state_place_valve()
    if clamp_place_valve_and_verify() then
...
while program_done == 0 do
    ...
    elseif current_state == S80_CLAMP_FILTER then
        state_clamp_filter()
    elseif current_state == S90_PICK_VALVE then
        state_pick_valve()
    elseif current_state == S95_PLACE_VALVE then
        state_place_valve()
