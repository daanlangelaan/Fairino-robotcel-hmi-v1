...
function hmi_publish_status()
    ...
    ModbusSlaveWriteAO(AO50, 1, a)
    ModbusSlaveWriteAO(AO51, 1, b)
    ModbusSlaveWriteAO(AO52, 1, c)
    ModbusSlaveWriteAO(AO53, 1, d)
    ModbusSlaveWriteAO(AO54, 1, c)
    ModbusSlaveWriteAO(AO55, 1, c)
end
-- END hmi_modbus.lua
