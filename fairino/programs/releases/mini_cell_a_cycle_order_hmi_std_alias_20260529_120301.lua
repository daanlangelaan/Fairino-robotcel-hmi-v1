...
function hmi_publish_status()
    ...
    ModbusSlaveWriteAO(AO50, 1, current_state)
    ModbusSlaveWriteAO(AO51, 1, fault_code)
    ModbusSlaveWriteAO(AO52, 1, cycle_counter)
    ModbusSlaveWriteAO(AO53, 1, batch_target)
    ModbusSlaveWriteAO(AO54, 1, cycle_counter)
    ModbusSlaveWriteAO(AO55, 1, cycle_counter)
end
-- END hmi_modbus.lua
