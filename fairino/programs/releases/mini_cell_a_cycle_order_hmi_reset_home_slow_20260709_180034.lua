...
CHECK_VALVE_FEED_SETTLE_TIME_MS = 300
...
function all_outputs_off()
    ...
    SetDO(DO_CHECK_VALVE_PRESS, 0, 0, 0)
    SetDO(DO_CHECK_VALVE_FEED, 0, 0, 0)
...
function check_valve_dispenser_prepare_pick()
    SetDO(DO_CHECK_VALVE_FEED, 1, 0, 0)
...
function press_check_valve_and_verify()
    SetDO(DO_CHECK_VALVE_PRESS, 1, 0, 0)
