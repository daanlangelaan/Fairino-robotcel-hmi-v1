...
-- Variant: a_cycle_order_hmi_do_status
-- Generated: 20260529_121426
...
function hmi_publish_status()
    ...
    ModbusSlaveWriteDO(DO108, 1, {heartbeat_bit})

    -- This SimMachine build rejects multiple ModbusSlaveWriteAO calls in one
    -- program. Keep the live HMI status on digital aliases for now.
end
-- END hmi_modbus.lua
