...
function hmi_publish_status()
    ...
    ModbusSlaveWriteDO("DO100", 1, {current_state == S30_WAIT_START and fault_code == FAULT_NONE and 1 or 0})
    ModbusSlaveWriteDO("DO101", 1, {program_done == 0 and current_state ~= S30_WAIT_START and fault_code == FAULT_NONE and 1 or 0})
    ModbusSlaveWriteDO("DO102", 1, {fault_code ~= FAULT_NONE and 1 or 0})
    ModbusSlaveWriteDO("DO103", 1, {sim_input("safety_ok") and 1 or 0})
    ModbusSlaveWriteDO("DO104", 1, {current_state == S110_APPLY_GLUE and 1 or 0})
    ModbusSlaveWriteDO("DO105", 1, {current_state >= S80_CLAMP_FILTER and current_state < S140_UNCLAMP_FILTER and fault_code == FAULT_NONE and 1 or 0})
    ModbusSlaveWriteDO("DO106", 1, {current_state >= S60_PICK_FILTER and current_state < S160_PLACE_IN_DRYING_ROW and fault_code == FAULT_NONE and 1 or 0})
    ...
    ModbusSlaveWriteAO("AO53", 1, {hmi_read_batch_target()})
...
-- A010_* points are simulator/demo points now and become real taught points later.
